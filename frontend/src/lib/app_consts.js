...
export const KEY_SELECTED_FILE = 'resizem-' + version + '-selected-file';
export const KEY_SHOW_IMAGE_DETAIL = 'resizem-' + version + '-show-image-detail';
export const KEY_IMAGE_DETAIL_DATA = 'resizem-' + version + '-image-detail-data';
...
export const EVENT_SHOW_IMAGE_DETAIL = 'resizem-' + version + '-show-image-detail';
export const EVENT_HIDE_IMAGE_DETAIL = 'resizem-' + version + '-hide-image-detail';
